...
# 250915
- otto diy base model aduino ide 구동, app inventer 로 블루투스 연결 및 조작 테스트
...
# 250912
- html to pptx convert object test, bs4 파싱 불완전, 잠정 중단

# 250911
- html to pptx 사용시 cdn 아이콘과 차트의 온전한 출력을 위해 selenium, puppeteer 사용해서 페이지 로드(지연시간 추가)

# 250910
- 포트폴리오 html, markdown 문서화, 전환된 문서 파일 프로필 사이트로 업데이트 하는 파이프라인 추가
...
# 250902
- 아두이노, 블록코딩 커뮤니티 홈페이지 제작, next.js, vercel, supabase, 서버리스
